...
# async def ai_suggestions(vitals: dict):
#     """Use Groq AI (Llama 3) to analyze vital signs and provide health suggestions."""
# ... (AI Suggestion route is kept commented out as it was in your file) ...
    ...
    try:
        while True:
            ...
            try:
                ...
                # Single frame error aane par chup-chap skip kar de, log spam na kare
                pass

    except WebSocketDisconnect:
        print("[WS] WebSocket client disconnected cleanly")
    except Exception:
         # Outer loop error ko bhi chup-chap handle kare
